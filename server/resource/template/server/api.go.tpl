...
import (
	"github.com/flipped-aurora/samrt-admin/server/global"
    "github.com/flipped-aurora/samrt-admin/server/model/autocode"
    "github.com/flipped-aurora/samrt-admin/server/model/common/request"
    autocodeReq "github.com/flipped-aurora/samrt-admin/server/model/autocode/request"
    "github.com/flipped-aurora/samrt-admin/server/model/common/response"
    "github.com/flipped-aurora/samrt-admin/server/service"
